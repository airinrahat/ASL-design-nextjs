  ...
  return (
    <div>
      <div className="bg-white text-black py-16 text-center">
        ...
        <div className="border border-gray-400 text-gray-500 lg:mx-36 my-4 p-4 flex items-center justify-between">
          <p className="flex-1">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Facere,
            assumenda mollitia iure nisi vel adipisci rerum aut corrupti nulla
            aliquam
          </p>
